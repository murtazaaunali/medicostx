        ...
        submit : function()
        {
            function createToken() {
                ...
                Stripe.card.createToken({
                    number: jQuery('#magenest_stripe_cc_number').val(),
                    cvc: jQuery('#magenest_stripe_cc_cid').val(),
                    exp_month: jQuery('#magenest_stripe_expiration').val(),
                    exp_year: jQuery('#magenest_stripe_expiration_yr').val(),
                    ...
                    if (response.error) {
                        ...
                        jQuery("#magenest_stripe_token").val(response.id);
                        console.log("done");

...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute() {
        ...
        try {
            ...
            {
				if($_FILES['myfile']['type'] != 'application/pdf') $error = true;
			}
			else
			{
				$error = true;
            ...
            $target_directory = $rootPath . "/pub/media/uploads/";
            ...
            $transport = $this->_transportBuilder->setTemplateIdentifier(
                ...
                ->addAttachment(file_get_contents($target_file), basename($_FILES["myfile"]["name"]))
                ->getTransport();
            ...
            $this->messageManager->addSuccess(__('Your resume has been submitted successfully. Someone from the HR Department will contact you soon!!'));
            return $resultRedirect->setUrl($redirectUrl);
        	...
        	if(isset($_FILES['myfile']) && $_FILES['myfile']['type'] != 'application/pdf') $custom_msg = "<br /> Only PDF file is allowed in attachment!";
        	
            $this->_inlineTranslation->resume();
            $this->messageManager->addException($e, __('Something went wrong '
                    . 'while sending the contact us request.' . $custom_msg));
        }
        return $resultRedirect->setUrl($redirectUrl);
    }
